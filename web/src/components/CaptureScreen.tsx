...
export default function CaptureScreen() {
    ...
    const stepLabel = flowStep === "capture" ? "Step 1 of 2 — Capture" : "Step 2 of 2 — Preview";
    ...
    return (
        <div
            ...
            <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-12 md:px-10">
                <header className="flex flex-col gap-3">
                    <span className="w-fit rounded-full border border-slate-200 bg-white/80 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-slate-600 shadow-sm">
                        {stepLabel}
                    </span>
